### ДЗ13. Настройка протоколов CDP, LLDP, NTP.
------
...
[Часть 2. Обнаружение сетевых ресурсов с помощью протокола CDP.](README.md#часть-2-обнаружение-сетевых-ресурсов-с-помощью-протокола-cdp)

[Часть 3. Обнаружение сетевых ресурсов с помощью протокола LLDP.](README.md#часть-3-обнаружение-сетевых-ресурсов-с-помощью-протокола-lldp)

[Часть 4. Настройка и проверка NTP.](README.md#часть-4-настройка-ntp)
...
Для выполнения работы изменим топологию. Добавим маршрутизатор R2 - IP  10.22.0.4/24.
...
e. С помощью соответствующей команды sh cdp просмотрим информацию о соседях коммутатора SW1.
...
Пример рабочей конфигурации маршрутизатора R1 приведен [здесь](/labs/lab13/Configs/Config%20R1_13.txt)

Пример рабочей конфигурации маршрутизатора R2 приведен [здесь](/labs/lab13/Configs/Config%20R2_13.txt)


Пример рабочей конфигурации коммутатора SW1  приведен [здесь](/labs/lab13/Configs/Config%20SW1_13.txt)

Пример рабочей конфигурации коммутатора SW2  приведен [здесь](/labs/lab13/Configs/Config%20SW2_13.txt)
