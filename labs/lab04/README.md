...
Рассмотрим структуру глобального индивидуального IPv6 адреса.  
В состав глобального индивидуального IPv6 адреса входит:  
* префикс глобальной маршрутизации - 48 первых бит (3 хекстета), выдаваемый провайдером,  

*  Идентификатор подсети - 16 бит (4-ый хекстет). Служит для разбиения на подсети;
*  Идентификатор интерфейса -64 бит (крайние 4 хекстета). Эквивалентен узловой части IPv4 адреса;

Заданный IPv6 адрес **2001:0db8:acad:0000:0000:0000:aaaa:1234/64**

Таким образом идентификатор подсети - **0000**
