...
2. На каждом некорневом коммутаторе назначаются корневые порты. Корневые порты имеют нименьшую стоимость до корневого коммутатора и смотрят в его сторону.  
