...
>Необходимо добавить имя пользователя и пароль каждого пользователя в локальную базу данных с помощью команды **username** и предоставить определенные права (привелегии) каждому пользователю.
 ...
 Пример рабочей конфигурации коммутатора SW1 приведен [здесь](/labs/lab05/configs/Config_SW1_Lab05.txt).

 Пример рабочей конфигурации маршрутизатора R1 приведен [здесь](/labs/lab05/configs/Config_R1_Lab05.txt)
