...
[Часть 2. Настройка и проверка NAT для IPv4.](README.md#часть-2-настройка-и-проверка-nat-для-ipv4)

[Часть 3. Настройка и проверка PAT для IPv4.](README.md#часть-3-настройка-и-проверка-pat-для-ipv4)

[Часть 4. Настройка и проверка статического NAT для IPv4.](README.md#часть-4-настройка-и-проверка-статического-nat-для-ipv4)
...
----
Для этого шага настройте статическое сопоставление между 192.168.1.2 и 209.165.200.1 с помощью следующей команды:
...
Пример рабочей конфигурации маршрутизатора R1 приведен [здесь](/labs/lab12/Configs/Config%20R1_12.txt)

Пример рабочей конфигурации маршрутизатора R2 приведен [здесь](/labs/lab12/Configs/Config%20R2_12.txt)


Пример рабочей конфигурации коммутатора SW1  приведен [здесь](/labs/lab12/Configs/Config%20SW1_12.txt)

Пример рабочей конфигурации коммутатора SW2  приведен [здесь](/labs/lab12/Configs/Config%20SW2_12.txt)
