...
[2. Проверка назначения адреса SLAAC от R1](README.md#2-проверка-назначения-адреса-slaac-от-r1)

[3. Настройка и проверка сервера DHCPv6 без гражданства на R1](README.md#3-настройка-и-проверка-сервера-dhcpv6-на-r1)

[4. Настройка и проверка состояния DHCPv6 сервера на R1](README.md#4-настройка-сервера-dhcpv6-с-сохранением-состояния-на-r1)

[5. Настройка и проверка DHCPv6 Relay на R2](README.md#5-настройка-и-проверка-ретрансляции-dhcpv6-на-r2)

[6. Настройка сервера DHCPv6 с сохранением состояния на R2.](README.md#6-настройка-сервера-dhcpv6-с-сохранением-состояния-на-r2)
...
```
  ...
  Пример рабочей конфигурации коммутатора SW1 приведен [здесь](/labs/lab08_1/configs/config%20SW1_08_1.txt)

Пример рабочей конфигурации коммутатора SW2 приведен [здесь](/labs/lab08_1/configs/config%20SW2_08_1.txt)

Пример рабочей конфигурации маршрутизатора R1 приведен [здесь](/labs/lab08_1/configs/config%20R1_08_1.txt)

Пример рабочей конфигурации маршрутизатора R2 приведен [здесь](/labs/lab08_1/configs/config%20R2_08_1.txt)