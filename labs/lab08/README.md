...
[2. Настройка и проверка двух серверов DHCPv4 на R1](README#2настройка-и-проверка-двух-серверов-dhcpv4-на-r1)

[3. Настройка и проверка DHCP-ретрансляции на R2](README#3настройка-и-проверка-dhcp-ретрансляции-на-r2)
